...
It recreates the classic snake gameplay with **dynamic speed control**, **score tracking**, and a **visual speed indicator panel**.  
---
### Features
...
- Visual speed indicator (Slow / Medium / Fast)  
